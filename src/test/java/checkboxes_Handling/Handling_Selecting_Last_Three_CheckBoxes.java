...
public class Handling_Selecting_Last_Three_CheckBoxes 
{
	public static void main(String[] args) throws InterruptedException 
	{
		...
		// select last 3 chexboxes 
		// total number of checkboxes-how may checkboxes want to select = staring index 
		// 7-3 = 4
