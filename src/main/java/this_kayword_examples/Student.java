...
public class Student 
{
       ...
       void dispalyDetails()
       {
    	   System.out.println("The stsudent name is : "+name);
    	   System.out.println("The stsudent id is :" + id);
    	   System.out.println("The stsudent age is : " + age);
    	   System.out.println("The stsudent surname is : " + surname);
